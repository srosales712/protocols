...
assay_name: "12S MarVer1 -Fluid"
assay_validation: not provided
targetTaxonomicAssay: The vertebrate mitochondrial 12S
target_gene: 12S rRNA (SSU mitochondria)
target_subfragment: 
ampliconSize: "202-238"
pcr_primer_forward: CGTGCCAGCCACCGCG
pcr_primer_reverse: GGGTATCTAATCCYAGTTTG
pcr_primer_name_forward: "12S MarVer1-F"
pcr_primer_name_reverse: "12S MarVer1-R"
pcr_primer_reference_forward: https://doi.org/10.1002/edn3.72
pcr_primer_reference_reverse: https://doi.org/10.1002/edn3.72
...
pcr_rep: 3
nucl_acid_amp: 
pcr_cond: initial denaturation:95_15;touchdown cycling;denaturation:94_0.5;
...
# NOAA/AOML PCR Protocol 12S MarVer1-Fluidigm - MIRe
...
| 96-well PCR Plate |  |  |  |  |
| Forward Primer - 12S MarVer1 F | 12S MarVer1 - F Fluidigm | IDT | 105 | (ul (10uM)) Primer must be diluted from 100uM stocks to 10uM |
| Reverse Primer - 12S MarVer1 R | 12S MarVer1 - R Fluidigm | IDT | 105 | (ul (10uM)) Primer must be diluted from 100uM stocks to 10uM |
| Gloves | Nitrile Gloves, Exam Grade, Powder-free | any | 1 | (box) Can be substituted with generic |
| Kim Wipes | KimWipe Delicate Task Wipers | KimTech | 1 | (box) Can be substituted with generic |
| 96-well PCR Plate |  |  |  |  |
| PCR Plate Seal | Silver seal, Aluminum, Traditional Adhesive | USA Scientific |  |  |
...
| Molecular water | Invitrogen RT-PCR Grade Water | Fisher Scientific | 500 | (uL) |
...
| Gel stain loading dye | DNA Gel Loading Dye (6x) | Thermo Scientific | 96 | (ul per plate) |
...
5.  Make PCR master mix:
    ...
    -   0.5 µL Fwd primer (10 μM; 0.4 μM final) - [12S MarVer1 - F Fluidigm](pcr_primer_name_forward)
    -   0.5 µL Rev primer (10 μM; 0.4 μM final) - [12S MarVer1 - R Fluidigm](pcr_primer_name_reverse)
    -   Add 1 µL of sample DNA (or molecular water for NTC) to respective triplicate wells for a total reaction volume of [12.5](amplificationReactionVolume) µL per well.
    -   Pipette up and down or vortex to fully distribute DNA into master mix.
    -   Add 1 µL of sample DNA (or molecular water for NTC) to respective triplicate wells for a total reaction volume of [12.5](amplificationReactionVolume) µL per well
...
|---------------|---------------|---------------|---------------|---------------|
| 12S MarVer1 F | forward | [CGTGCCAGCCACCGCG](pcr_primer_forward) | ACACTGACGACATGGTTCTACA xxx [CGTGCCAGCCACCGCG](pcr_primer_forward) | CS1-TS-F |
| 12S MarVer1 R | reverse | [GGGTATCTAATCCYAGTTTG](pcr_primer_reverse) | TACGGTAGCAGAGACTTGGTCT xxx [GGGTATCTAATCCYAGTTTG](pcr_primer_reverse) | CS2-TS-R |

7.  Load plate onto thermal cycler and select "12s MarVer1PLAT" program to run the following steps:
...
3.  In a 1L glass container, prepare **1 L of 1× TBE** by adding **100 mL of 10× TBE stock** to **900 mL DI water**. Mix thoroughly.
...
1.  After performing a gel on the PCR products, pipette 10 µL of each sample into their respective wells of a new 96-well PCR plate.
    -   Leave a well empty for Michigan State's sequencing negative control
...
-   If there are contamination bands appearing on the gel, run another PCR ensuring full sterilization of work spaces and equipment under the hood and use new vials of Taq and molecular water. If diluted primers are contaminated, use freshly-made aliquot of primers.
