...
assay_name: "16S MarVer3 -Fluid"
assay_validation: not provided
targetTaxonomicAssay: The vertebrate mitochondrial 16S
target_gene: 16S rRNA (LSU mitochondria)
target_subfragment: 
ampliconSize: "245-281"
pcr_primer_forward: AGACGAGAAGACCCTRTG
pcr_primer_reverse: GGATTGCGCTGTTATCCC
pcr_primer_name_forward: "16S MarVer3-F"
pcr_primer_name_reverse: "16S MarVer3-R"
...
# NOAA/AOML PCR Protocol 16S MarVer3-Fluidigm - MIRe
...
This protocol is used for PCR amplifying the 16S rRNA marker gene regions of environmental DNA. Adapters are already present on the primers described in the following protocol.
...
| 96-well PCR Plate |  |  |  |  |
| Forward Primer - 16S MarVer3 F | 16S MarVer3 - F Fluidigm | IDT | 105 | (ul (10uM)) Primer must be diluted from 100uM stocks to 10uM |
| Reverse Primer - 16S MarVer3 R | 16S MarVer3 - R Fluidigm | IDT | 105 | (ul (10uM)) Primer must be diluted from 100uM stocks to 10uM |
...
-   0.5 µL Fwd primer (10 μM; 0.4 μM final) - [16S MarVer3 - F Fluidigm](pcr_primer_name_forward)

-   0.5 µL Rev primer (10 μM; 0.4 μM final) - [16S MarVer3 - R Fluidigm](pcr_primer_name_reverse)
...
|---------------|---------------|---------------|---------------|---------------|
| 16S MarVer3 F | forward | [AGTTACYYTAGGGATAACAGCG](pcr_primer_forward) | ACACTGACGACATGGTTCTACA xxx [AGTTACYYTAGGGATAACAGCG](pcr_primer_forward) | CS1-TS-F |
| 16S MarVer3 R | reverse | [TCCGGTCTGAACTCAGATCAYGT](pcr_primer_reverse) | TACGGTAGCAGAGACTTGGTCT xxx [TCCGGTCTGAACTCAGATCAYGT](pcr_primer_reverse) | CS2-TS-R |

7.  Load plate onto thermal cycler and select "16s MarVer3PLAT" program to run the following steps:
