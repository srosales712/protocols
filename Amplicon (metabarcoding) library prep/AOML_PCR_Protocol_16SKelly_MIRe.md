...
assay_name: "Kelly-Metazoan-16S-Fluidigm"
assay_validation: not provided
targetTaxonomicAssay: Metazoa
targetTaxonomicScope: "Metazoan invertebrates and vertebrate diversity"
target_gene: 16S rRNA (mitochondrial LSU)
target_subfragment: ""
ampliconSize: "114-160"
pcr_primer_forward: AGTTACYYTAGGGATAACAGCG
pcr_primer_reverse: TCCGGTCTGAACTCAGATCAYGT
pcr_primer_name_forward: "16S-Kelly-F"
pcr_primer_name_reverse: "16S-Kelly-R"
pcr_primer_reference_forward: https://doi.org/10.1371/journal.pone.0144487
pcr_primer_reference_reverse: https://doi.org/10.1371/journal.pone.0144487
...
custom_mm: PCR reactions were run in 12.5 µL reaction volumes, with 1.0 µL of DNA, 6.25 µL of Platinum™ Hot Start PCR Master Mixes (2X), 4.25 µL of molecular water, and 0.5 µL of each primer (10 µM).
block_seq: not applicable
block_ref: not applicable
block_taxa: not applicable
pcr_rep: 3
nucl_acid_amp: "https://github.com/marinednadude/NOAA-PMEL-OME-Kelly-Metazoan-16S-PCR-Protocol-BeBOP-/blob/main/NOAA-PMEL-OME-Kelly-Metazoan-16S-PCR-Protocol-BeBOP.md"
pcr_cond: initial denaturation:95_15;touchdown cycling;denaturation:94_0.5;annealing:60_0.5;elongation:72_1.5;13;normal cycling;denaturation:94_0.5;annealing:46_0.5;elongation:72_0.75;25;final elongation:72_10;hold:4
annealingTemp: 60.0
pcr_cycles: 38
...
# NOAA/AOML PCR Protocol Kelly Metazoan 16S - MIRe
...
|----|----|----|----|
| NOAA-PMEL-OME Kelly Metazoan 16S PCR Protocol BeBOP | <https://github.com/marinednadude/NOAA-PMEL-OME-Kelly-Metazoan-16S-PCR-Protocol-BeBOP-/blob/main/NOAA-PMEL-OME-Kelly-Metazoan-16S-PCR-Protocol-BeBOP.md> | NOAA PMEL OME | 2026-08-11 |
...
This protocol describes steps for performing PCR for [16S rRNA](target_gene) marker gene regions using eDNA extracted from Sterivex at NOAA AOML. The PCR protocol only includes a primary PCR step as the secondary PCR, library preparation, and sequencing is completed by Michigan State University's RTSF Genomics Core.
Steps related to preparing samples for sequencing and the Genomics Core's procedure are included.
This protocol closely follows along with the NOAA PMEL OME Kelly Metazoan 16S BeBOP protocol: <https://github.com/marinednadude/NOAA-PMEL-OME-Kelly-Metazoan-16S-PCR-Protocol-BeBOP-/blob/main/NOAA-PMEL-OME-Kelly-Metazoan-16S-PCR-Protocol-BeBOP.md>.

### Method description and rationale

This protocol is used for PCR amplifying the Kelly Metazoan 16S rRNA marker gene regions of environmental DNA.
Fluidigm adapters CS1 & CS2 are already present on the primers described in the following protocol.
This protocol variant was developed to reduce off-target amplification and increase the brightness of the target band.

### Spatial coverage and environment(s) of relevance

This protocol can be used to amplify the 16S marker gene region of any metazoan eDNA sample.
...
Handle ethanol, RNase AWAY / DNA Decontaminant, and SYBR Safe according to institutional safety procedures and SDS requirements.
...
1.  Map out order of samples on 96-well PCR plate.
    Make sure to leave a space for a no template control (NTC) and positive control for each PCR plate.

2.  Label master mix tube, PCR plates, and any other consumables.

3.  Dilute primers from 100 µM to 10 µM if not already at 10 µM using the dilution equation:

    (C1)(V1) = (C2)(V2)

4.  Place PCR consumables and molecular-grade water under UV sterilization for 15 minutes.

5.  Set up PCR under hood by wiping off all surfaces, pipettes, and racks with DNA-Away/Bleach or RNase AWAY solution and UV sterilizing for 20 mins.
...
5.  Make PCR master mix (per single 12.5 µL reaction):
    ...
    -   0.5 µL Fwd primer (10 µM stock; 0.4 µM final) - 16S-Kelly-F
    -   0.5 µL Rev primer (10 µM stock; 0.4 µM final) - 16S-Kelly-R
    -   Add 1 µL of sample DNA extract template (or molecular water for NTC) for a total reaction volume of 12.5 µL per well. Pipette up and down or vortex to fully distribute DNA into master mix.
...
|----|----|----|----|----|
| 16S-Kelly-F | forward | AGTTACYYTAGGGATAACAGCG | ACACTGACGACATGGTTCTACA xxx AGTTACYYTAGGGATAACAGCG | CS1-TS-F |
| 16S-Kelly-R | reverse | TCCGGTCTGAACTCAGATCAYGT | TACGGTAGCAGAGACTTGGTCT xxx TCCGGTCTGAACTCAGATCAYGT | CS2-TS-R |
...
**Purpose:** A 2% agarose gel to confirm the presence and approximate size of the target amplicon (114–160 bp).
...
-   Kelly RP, Closek CJ, O’Donnell JL, Kralj JE, Shelton AO, Samhouri JF. (2016) Genetic signatures of ecological diversity along an urbanization gradient. *PeerJ*, 4:e2444. <https://doi.org/10.7717/peerj.2444>
